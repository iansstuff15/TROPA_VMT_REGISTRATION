...
export default async function handler(req, res) {
  ...
  const  spreadsheetId = process.env.SHEETS_ID;
   await googleSheets.spreadsheets.values.append({
       auth,
       spreadsheetId,
       range:'Donations_Reciept_Monetary!A2',
       valueInputOption: 'USER_ENTERED',
       resource: {
           values:[[
           body.RID, body.firstName,body.lastName,body.email,body.phone,body.mode,body.amount, body.date_recieved, now, body.RefNum
            ]]
       }
   })
   await googleSheets.spreadsheets.values.append({
    auth,
    spreadsheetId,
    range:'Public_Monetary_Donations_Data!A2',
    valueInputOption: 'USER_ENTERED',
    resource: {
        values:[[
        body.RID, body.amount, body.date_recieved,
         ]]
    }
})
 ...
 <html style="margin: 0;padding: 0;border: 0;">
     ...
     <body style="margin: 0 auto;padding: 4%;border: 0;background-color: #ffd7ea;background-image: url(https://i.ibb.co/1Rkw4G7/Whats-App-Image-2022-03-27-at-1-22-30-AM.jpg);background-repeat: no-repeat;background-size: cover;height: 100%;background-blend-mode: luminosity;font-size: 1em;max-width: 800px;">
         ...
         <p style="margin: 40px 0;padding: 0;border: 0;font-weight: normal;font-family: 'Raleway', sans-serif;text-align: justify;background-color: white;text-decoration: none;">
             ...
             <p style="margin: 40px 0;padding: 0;border: 0;font-weight: normal;font-family: 'Raleway', sans-serif;text-align: justify;background-color: white;text-decoration: none;">Ito po ang magsisilbi bilang Official Acknowledgement ng inyong contribution: 
             </p>
             <p style="margin: 40px 0;padding: 0;border: 0;font-weight: normal;font-family: 'Raleway', sans-serif;text-align: justify;background-color: white;text-decoration: none;">  <span class="grey_highlight" style="margin: 0;padding: 20px;border: 0;font-weight: bolder;font-family: 'Raleway', sans-serif;text-decoration: none;background-color: #EDEDED;margin-bottom: 10px;border-radius: 10px;text-align: center;display: inline-flex;margin-right: 10px;"><strong style="margin: 0;padding: 0;border: 0;">Name of giver: </strong> ${body.lastName+ ', '+ body.firstName} </span> <span class="grey_highlight" style="margin: 0;padding: 20px;border: 0;font-weight: bolder;font-family: 'Raleway', sans-serif;text-decoration: none;background-color: #EDEDED;margin-bottom: 10px;border-radius: 10px;text-align: center;display: inline-flex;margin-right: 10px;"> <strong style="margin: 0;padding: 0;border: 0;">Date Received: </strong> ${body.date_recieved}</span> <br style="margin: 0;padding: 0;border: 0;"><span class="pink_highlight" style="margin: 0;padding: 20px;border: 0;font-weight: bolder;font-family: 'Raleway', sans-serif;text-decoration: none;background-color: #fc368c;color: white;border-radius: 10px;text-align: center;display: inline-block;width: 90%;"><strong style="margin: 0;padding: 0;border: 0;">Amout Recieved: </strong> ₱. ${body.amount}</span></p>
             ...
             <div style="margin: 0;padding: 0;border: 0;"><a href="#" class="button" style="margin: 0;padding: 20px;border: 0;font-weight: bolder;font-family: 'Raleway', sans-serif;text-decoration: none;background-color: #fc368c;color: white;border-radius: 10px;text-align: center;display: inline-block;height: 100%;margin-bottom: 20px;">View donations summary</a></div>
